...
C**************************************************************
      ...
      COMMON/DUMP/JDUMP(10),IDUMP,KDUMP,MDUMP
...
204   FORMAT(I4)
205   FORMAT(1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2)
...
204   FORMAT(I4)
205   FORMAT(1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2,
     1       1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2)
206   FORMAT(A2,1X,3F20.10)
208   FORMAT(3F20.10)
C**ONLY DUMP IF UNIQUE SYMMETRY
      DO I=1,NWSYM
...
205   FORMAT(1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2,
     1       1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2,
     2       1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2)
206   FORMAT(A2,1X,3F20.10)
208   FORMAT(4F20.10)
C**ONLY DUMP IF UNIQUE SYMMETRY
      DO I=1,NWSYM
...
205   FORMAT(1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2,
     1       1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2,
     2       1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2,
     3       1X,'MODE:',I2,' SYMMETRY:',A3,' POINT:',I2)
206   FORMAT(A2,1X,3F20.10)
208   FORMAT(5F20.10)
